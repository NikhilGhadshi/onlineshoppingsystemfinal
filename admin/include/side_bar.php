...
<li><button style="width:240px; height:50px" type="button" class="btn btn-default btn-danger" onClick="location.href='.././index.php'"><span class="glyphicon glyphicon-off pull-left">
